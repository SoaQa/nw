...
print("Предсказание 1: ", predictions[0])

print("какой метке соответствует максимальное значение: ", np.argmax(predictions[0]))

print("Сравним значение с исходным: ", test_labels[0])
...
"""Метод model.predict возвращает нам список списков, 
по одному для каждой картинки в пакете данных. Получите прогнозы для нашего (единственного) изображения в пакете:"""
